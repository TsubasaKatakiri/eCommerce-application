        ...
        <div className='product-list'>
            ...
            <div className='product-list_pagination'>
                ...
                <div className='product-list_page-buttons'>
                    <button className='pagination-button' disabled={pageNumber === 0} onClick={() => setPageNumber((prev) => prev - 1)}>Back</button>
                    {paginationButtons}
                    <button className='pagination-button' disabled={total-offset < limit} onClick={() => setPageNumber((prev) => prev + 1)}>Next</button>
                </div>
            </div>
        </div>
    );
