		...
		<form className="singup-form__wrapper" onSubmit={handleSubmit(onSubmit)}>
			...
			<div className="singup-form__input-group">
				...
				<p className="singup-form__error">
					The password must contain at least 8 characters. Of these: 1 uppercase letter, 1 lowercase letter and 1
					digit.
				</p>
				)}
			</div>
			...
			<fieldset className="singup-form__fielset">
				...
				<div className="singup-form__input-group">
					...
					/>
					{errors.billingStreet?.type === 'required' && <p className="singup-form__error">Street is required.</p>}
				...
				<div className="singup-form__input-group">
					...
					/>
					{errors.billingPostal?.type === 'required' && <p className="singup-form__error">postal is required.</p>}
