...
export const clearCart = async (id: string, version: number, lineItemIds: string[], dispatch: Dispatch<UnknownAction>): Promise<void> => {
  ...
  const actions: CartUpdateAction[] = lineItemIds.map(lineItemId => ({
